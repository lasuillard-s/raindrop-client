...
**parent** | [**CollectionRef**](CollectionRef.md) |  | [default to undefined]

## Example

```typescript
import { GetChildCollectionsResponseItemsInner } from './api';

const instance: GetChildCollectionsResponseItemsInner = {
    _id,
    title,
    description,
    user,
